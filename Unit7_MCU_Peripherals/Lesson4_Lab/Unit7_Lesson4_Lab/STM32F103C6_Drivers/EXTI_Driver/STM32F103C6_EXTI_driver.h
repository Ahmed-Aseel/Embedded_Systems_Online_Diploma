...
#ifndef EXTI_DRIVER_STM32F103C6_EXTI_DRIVER_H_
#define EXTI_DRIVER_STM32F103C6_EXTI_DRIVER_H_
...
typedef struct
{
	...
	uint8_t 			 Trigger_Case ;  // Specifies Rising or Falling or Both of them
	 	 	 	 	 	 	 	 	 	 // This parameter can be a value of @ref EXTI_Trigger_define

	uint8_t 			 IRQ_EN		  ;  // Enable or Disable IRQ this will enable IRQ MASK in EXTI & also NVIC Interrupt
	 	 	 	 	 	 	 	 	 	 // This parameter can be a value of @ref EXTI_IRQ_define

	void (*P_IRQ_CallBack)(void)	  ;  // Set the Interrupt Handler function that will be called once the IRQ
...
#endif /* EXTI_DRIVER_STM32F103C6_EXTI_DRIVER_H_ */
